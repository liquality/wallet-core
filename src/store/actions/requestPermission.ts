...
function createPopup(route: string, func) {
  // TODO: popup and resolve
}
...
export const requestPermission = async (
  ...
  if (!requestPermissionActive) {
    commit(
      'app/SET_REQUEST_PERMISSION_ACTIVE',
      { active: true },
      { root: true }
    );
