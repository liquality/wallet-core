...
export interface L1ArbitrumMessengerInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "depositEthRetryable", values: [string, BigNumberish, BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "depositEthRetryable", data: BytesLike): Result;
...
export interface L1ArbitrumMessenger extends BaseContract {
    ...
    functions: {
        ...
        createRetryableTicket(destAddr: string, arbTxCallValue: BigNumberish, maxSubmissionCost: BigNumberish, submissionRefundAddress: string, valueRefundAddress: string, maxGas: BigNumberish, gasPriceBid: BigNumberish, data: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        depositEth(destAddr: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        depositEthRetryable(destAddr: string, maxSubmissionCost: BigNumberish, maxGas: BigNumberish, maxGasPrice: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        bridge(overrides?: CallOverrides): Promise<string>;
        createRetryableTicket(destAddr: string, arbTxCallValue: BigNumberish, maxSubmissionCost: BigNumberish, submissionRefundAddress: string, valueRefundAddress: string, maxGas: BigNumberish, gasPriceBid: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        depositEth(destAddr: string, overrides?: CallOverrides): Promise<BigNumber>;
        depositEthRetryable(destAddr: string, maxSubmissionCost: BigNumberish, maxGas: BigNumberish, maxGasPrice: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
...
//# sourceMappingURL=L1ArbitrumMessenger.d.ts.map