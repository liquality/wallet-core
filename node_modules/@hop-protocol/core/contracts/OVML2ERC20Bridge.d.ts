...
export interface OVML2ERC20BridgeInterface extends utils.Interface {
    contractName: "OVML2ERC20Bridge";
    functions: {
        "l1ERC20BridgeAddress()": FunctionFragment;
        "l2Messenger()": FunctionFragment;
        "withdraw(address,address,uint256)": FunctionFragment;
    };
    encodeFunctionData(functionFragment: "l1ERC20BridgeAddress", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "l1ERC20BridgeAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "l2Messenger", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "withdraw", data: BytesLike): Result;
    events: {};
}
export interface OVML2ERC20Bridge extends BaseContract {
    contractName: "OVML2ERC20Bridge";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OVML2ERC20BridgeInterface;
...
//# sourceMappingURL=OVML2ERC20Bridge.d.ts.map