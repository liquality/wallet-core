...
export interface L2BridgeWrapperInterface extends utils.Interface {
    contractName: "L2BridgeWrapper";
    functions: {
    ...
    encodeFunctionData(functionFragment: "addSupportedChainIds", values: [BigNumberish[]]): string;
    ...
    encodeFunctionData(functionFragment: "distribute", values: [string, BigNumberish, BigNumberish, BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "l1MessengerWrapperAddress", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "messengerGasLimit", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "removeSupportedChainIds", values: [BigNumberish[]]): string;
    ...
    encodeFunctionData(functionFragment: "setL1MessengerWrapperAddress", values: [string]): string;
    encodeFunctionData(functionFragment: "setMaxPendingTransfers", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setMessengerGasLimit", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "setUniswapWrapper", values: [string]): string;
    encodeFunctionData(functionFragment: "settleBondedWithdrawal", values: [string, BytesLike, BytesLike, BigNumberish, BytesLike[]]): string;
    ...
    encodeFunctionData(functionFragment: "supportedChainIds", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "transferNonceIncrementer", values?: undefined): string;
    encodeFunctionData(functionFragment: "uniswapWrapper", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "addSupportedChainIds", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "l1MessengerWrapperAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "messengerGasLimit", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "removeSupportedChainIds", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setL1MessengerWrapperAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setMaxPendingTransfers", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setMessengerGasLimit", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setUniswapWrapper", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "uniswapWrapper", data: BytesLike): Result;
...
export declare type StakeEvent = TypedEvent<[BigNumber], {
    amount: BigNumber;
}>;
...
export declare type UnstakeEvent = TypedEvent<[BigNumber], {
    amount: BigNumber;
}>;
...
export interface L2BridgeWrapper extends BaseContract {
    contractName: "L2BridgeWrapper";
    ...
    functions: {
        ...
        addSupportedChainIds(chainIds: BigNumberish[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        distribute(recipient: string, amount: BigNumberish, amountOutMin: BigNumberish, deadline: BigNumberish, relayerFee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        removeSupportedChainIds(chainIds: BigNumberish[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setL1MessengerWrapperAddress(_l1MessengerWrapperAddress: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setMaxPendingTransfers(_maxPendingTransfers: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setMessengerGasLimit(_messengerGasLimit: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setUniswapWrapper(_uniswapWrapper: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        settleBondedWithdrawal(bonder: string, transferId: BytesLike, rootHash: BytesLike, transferRootTotalAmount: BigNumberish, proof: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        supportedChainIds(arg0: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        withdraw(recipient: string, amount: BigNumberish, transferNonce: BytesLike, bonderFee: BigNumberish, amountOutMin: BigNumberish, deadline: BigNumberish, rootHash: BytesLike, transferRootTotalAmount: BigNumberish, proof: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    addBonder(bonder: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        addSupportedChainIds(chainIds: BigNumberish[], overrides?: CallOverrides): Promise<void>;
        ...
        defaultGasLimit(overrides?: CallOverrides): Promise<number>;
        distribute(recipient: string, amount: BigNumberish, amountOutMin: BigNumberish, deadline: BigNumberish, relayerFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
        getBondedWithdrawalAmount(bonder: string, transferId: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        getChainId(overrides?: CallOverrides): Promise<BigNumber>;
        getCredit(bonder: string, overrides?: CallOverrides): Promise<BigNumber>;
        getDebitAndAdditionalDebit(bonder: string, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        removeSupportedChainIds(chainIds: BigNumberish[], overrides?: CallOverrides): Promise<void>;
        ...
        setL1MessengerWrapperAddress(_l1MessengerWrapperAddress: string, overrides?: CallOverrides): Promise<void>;
        setMaxPendingTransfers(_maxPendingTransfers: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setMessengerGasLimit(_messengerGasLimit: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        setUniswapWrapper(_uniswapWrapper: string, overrides?: CallOverrides): Promise<void>;
        settleBondedWithdrawal(bonder: string, transferId: BytesLike, rootHash: BytesLike, transferRootTotalAmount: BigNumberish, proof: BytesLike[], overrides?: CallOverrides): Promise<void>;
        ...
        withdraw(recipient: string, amount: BigNumberish, transferNonce: BytesLike, bonderFee: BigNumberish, amountOutMin: BigNumberish, deadline: BigNumberish, rootHash: BytesLike, transferRootTotalAmount: BigNumberish, proof: BytesLike[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        ...
        "TransferSent(bytes32,address,uint256,bytes32,uint256,uint256)"(transferId?: BytesLike | null, recipient?: string | null, amount?: null, transferNonce?: BytesLike | null, bonderFee?: null, index?: null): TransferSentEventFilter;
        TransferSent(transferId?: BytesLike | null, recipient?: string | null, amount?: null, transferNonce?: BytesLike | null, bonderFee?: null, index?: null): TransferSentEventFilter;
        "TransfersCommitted(bytes32,uint256,uint256)"(rootHash?: BytesLike | null, totalAmount?: null, rootCommittedAt?: null): TransfersCommittedEventFilter;
        TransfersCommitted(rootHash?: BytesLike | null, totalAmount?: null, rootCommittedAt?: null): TransfersCommittedEventFilter;
        ...
        "WithdrawalBonded(bytes32,address,uint256,bytes32,uint256)"(transferId?: BytesLike | null, recipient?: string | null, amount?: null, transferNonce?: null, bonderFee?: null): WithdrawalBondedEventFilter;
        WithdrawalBonded(transferId?: BytesLike | null, recipient?: string | null, amount?: null, transferNonce?: null, bonderFee?: null): WithdrawalBondedEventFilter;
    ...
    estimateGas: {
        ...
        supportedChainIds(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        transferNonceIncrementer(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        supportedChainIds(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=L2BridgeWrapper.d.ts.map