...
export interface IOVMBaseCrossDomainMessengerInterface extends utils.Interface {
    contractName: "IOVMBaseCrossDomainMessenger";
    functions: {
    ...
    encodeFunctionData(functionFragment: "deposit", values: [string, BigNumberish, boolean]): string;
...
export declare type SentMessageEvent = TypedEvent<[string], {
    message: string;
}>;
export declare type SentMessageEventFilter = TypedEventFilter<SentMessageEvent>;
export interface IOVMBaseCrossDomainMessenger extends BaseContract {
    contractName: "IOVMBaseCrossDomainMessenger";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IOVMBaseCrossDomainMessengerInterface;
    ...
    functions: {
        deposit(_depositor: string, _amount: BigNumberish, _send: boolean, overrides?: Overrides & {
    ...
    xDomainMessageSender(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        deposit(_depositor: string, _amount: BigNumberish, _send: boolean, overrides?: CallOverrides): Promise<void>;
...
//# sourceMappingURL=IOVMBaseCrossDomainMessenger.d.ts.map