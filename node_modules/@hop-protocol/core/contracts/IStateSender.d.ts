...
export interface IStateSenderInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "syncState", values: [string, BytesLike]): string;
...
export interface IStateSender extends BaseContract {
    ...
    functions: {
        syncState(receiver: string, data: BytesLike, overrides?: Overrides & {
    ...
    callStatic: {
        syncState(receiver: string, data: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        syncState(receiver: string, data: BytesLike, overrides?: Overrides & {
