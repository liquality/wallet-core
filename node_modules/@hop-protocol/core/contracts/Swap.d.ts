...
export interface SwapInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "calculateRemoveLiquidityOneToken", values: [string, BigNumberish, BigNumberish]): string;
...
export interface Swap extends BaseContract {
    ...
    functions: {
        ...
        calculateRemoveLiquidityOneToken(account: string, tokenAmount: BigNumberish, tokenIndex: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber] & {
        ...
        calculateTokenAmount(account: string, amounts: BigNumberish[], deposit: boolean, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        initialize(_pooledTokens: string[], decimals: BigNumberish[], lpTokenName: string, lpTokenSymbol: string, _a: BigNumberish, _fee: BigNumberish, _adminFee: BigNumberish, _withdrawFee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        updateUserWithdrawFee(recipient: string, transferAmount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    addLiquidity(amounts: BigNumberish[], minToMint: BigNumberish, deadline: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        getTokenIndex(tokenAddress: string, overrides?: CallOverrides): Promise<number>;
        getVirtualPrice(overrides?: CallOverrides): Promise<BigNumber>;
        initialize(_pooledTokens: string[], decimals: BigNumberish[], lpTokenName: string, lpTokenSymbol: string, _a: BigNumberish, _fee: BigNumberish, _adminFee: BigNumberish, _withdrawFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        ...
        calculateRemoveLiquidity(account: string, amount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        calculateRemoveLiquidityOneToken(account: string, tokenAmount: BigNumberish, tokenIndex: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        calculateTokenAmount(account: string, amounts: BigNumberish[], deposit: boolean, overrides?: CallOverrides): Promise<PopulatedTransaction>;
