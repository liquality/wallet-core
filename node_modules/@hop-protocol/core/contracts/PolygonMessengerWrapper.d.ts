...
export interface PolygonMessengerWrapperInterface extends utils.Interface {
    contractName: "PolygonMessengerWrapper";
    functions: {
...
export interface PolygonMessengerWrapper extends BaseContract {
    ...
    estimateGas: {
        ...
        verifySender(l1BridgeCaller: string, arg1: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        verifySender(l1BridgeCaller: string, arg1: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=PolygonMessengerWrapper.d.ts.map