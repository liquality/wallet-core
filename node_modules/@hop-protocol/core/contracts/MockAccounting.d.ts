...
export interface MockAccountingInterface extends utils.Interface {
    contractName: "MockAccounting";
    functions: {
...
export interface MockAccounting extends BaseContract {
    contractName: "MockAccounting";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockAccountingInterface;
...
//# sourceMappingURL=MockAccounting.d.ts.map