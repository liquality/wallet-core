...
export interface L1XDaiMessengerInterface extends utils.Interface {
    contractName: "L1XDaiMessenger";
    functions: {
...
export interface L1XDaiMessenger extends BaseContract {
    contractName: "L1XDaiMessenger";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: L1XDaiMessengerInterface;
...
//# sourceMappingURL=L1XDaiMessenger.d.ts.map