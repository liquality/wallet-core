...
export interface ISwapFlashLoanInterface extends utils.Interface {
    contractName: "ISwapFlashLoan";
    functions: {
...
export interface ISwapFlashLoan extends BaseContract {
    contractName: "ISwapFlashLoan";
    ...
    functions: {
        ...
        initialize(pooledTokens: string[], decimals: BigNumberish[], lpTokenName: string, lpTokenSymbol: string, a: BigNumberish, fee: BigNumberish, adminFee: BigNumberish, withdrawFee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getTokenIndex(tokenAddress: string, overrides?: CallOverrides): Promise<number>;
        getVirtualPrice(overrides?: CallOverrides): Promise<BigNumber>;
        initialize(pooledTokens: string[], decimals: BigNumberish[], lpTokenName: string, lpTokenSymbol: string, a: BigNumberish, fee: BigNumberish, adminFee: BigNumberish, withdrawFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
        isGuarded(overrides?: CallOverrides): Promise<boolean>;
...
//# sourceMappingURL=ISwapFlashLoan.d.ts.map