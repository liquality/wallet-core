...
export interface YVaultInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "permit", values: [string, string, BigNumberish, BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "addStrategy", values: [string, BigNumberish, BigNumberish, BigNumberish, BigNumberish]): string;
...
export declare type StrategyAddedEvent = TypedEvent<[
    string,
    BigNumber,
    BigNumber,
    BigNumber,
...
export declare type StrategyReportedEvent = TypedEvent<[
    string,
    BigNumber,
    BigNumber,
    BigNumber,
...
export declare type StrategyReportedEventFilter = TypedEventFilter<StrategyReportedEvent>;
...
export declare type UpdateManagementEvent = TypedEvent<[
    string
], {
    management: string;
}>;
export declare type UpdateManagementEventFilter = TypedEventFilter<UpdateManagementEvent>;
export declare type UpdateRewardsEvent = TypedEvent<[string], {
    rewards: string;
}>;
export declare type UpdateRewardsEventFilter = TypedEventFilter<UpdateRewardsEvent>;
export declare type UpdateDepositLimitEvent = TypedEvent<[
    BigNumber
], {
    depositLimit: BigNumber;
}>;
export declare type UpdateDepositLimitEventFilter = TypedEventFilter<UpdateDepositLimitEvent>;
export declare type UpdatePerformanceFeeEvent = TypedEvent<[
    BigNumber
], {
    performanceFee: BigNumber;
}>;
export declare type UpdatePerformanceFeeEventFilter = TypedEventFilter<UpdatePerformanceFeeEvent>;
export declare type UpdateManagementFeeEvent = TypedEvent<[
    BigNumber
], {
    managementFee: BigNumber;
}>;
export declare type UpdateManagementFeeEventFilter = TypedEventFilter<UpdateManagementFeeEvent>;
export declare type UpdateGuardianEvent = TypedEvent<[string], {
    guardian: string;
}>;
export declare type UpdateGuardianEventFilter = TypedEventFilter<UpdateGuardianEvent>;
export declare type EmergencyShutdownEvent = TypedEvent<[boolean], {
    active: boolean;
}>;
export declare type EmergencyShutdownEventFilter = TypedEventFilter<EmergencyShutdownEvent>;
export declare type UpdateWithdrawalQueueEvent = TypedEvent<[
    string[]
], {
    queue: string[];
}>;
export declare type UpdateWithdrawalQueueEventFilter = TypedEventFilter<UpdateWithdrawalQueueEvent>;
export declare type StrategyUpdateDebtRatioEvent = TypedEvent<[
    string,
    BigNumber
], {
    strategy: string;
...
export declare type StrategyUpdateDebtRatioEventFilter = TypedEventFilter<StrategyUpdateDebtRatioEvent>;
export declare type StrategyUpdateMinDebtPerHarvestEvent = TypedEvent<[
    string,
    BigNumber
], {
    strategy: string;
...
export declare type StrategyUpdateMinDebtPerHarvestEventFilter = TypedEventFilter<StrategyUpdateMinDebtPerHarvestEvent>;
export declare type StrategyUpdateMaxDebtPerHarvestEvent = TypedEvent<[
    string,
    BigNumber
], {
    strategy: string;
...
export declare type StrategyUpdateMaxDebtPerHarvestEventFilter = TypedEventFilter<StrategyUpdateMaxDebtPerHarvestEvent>;
export declare type StrategyUpdatePerformanceFeeEvent = TypedEvent<[
    string,
    BigNumber
], {
    strategy: string;
...
export declare type StrategyUpdatePerformanceFeeEventFilter = TypedEventFilter<StrategyUpdatePerformanceFeeEvent>;
export declare type StrategyMigratedEvent = TypedEvent<[
    string,
    string
], {
    oldVersion: string;
...
export declare type StrategyMigratedEventFilter = TypedEventFilter<StrategyMigratedEvent>;
export declare type StrategyRevokedEvent = TypedEvent<[string], {
    strategy: string;
}>;
export declare type StrategyRevokedEventFilter = TypedEventFilter<StrategyRevokedEvent>;
export declare type StrategyRemovedFromQueueEvent = TypedEvent<[
    string
], {
    strategy: string;
}>;
export declare type StrategyRemovedFromQueueEventFilter = TypedEventFilter<StrategyRemovedFromQueueEvent>;
export declare type StrategyAddedToQueueEvent = TypedEvent<[
    string
], {
    strategy: string;
}>;
export declare type StrategyAddedToQueueEventFilter = TypedEventFilter<StrategyAddedToQueueEvent>;
export interface YVault extends BaseContract {
    ...
    functions: {
        "initialize(address,address,address,string,string)"(token: string, governance: string, rewards: string, nameOverride: string, symbolOverride: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "initialize(address,address,address,string,string,address)"(token: string, governance: string, rewards: string, nameOverride: string, symbolOverride: string, guardian: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "initialize(address,address,address,string,string,address,address)"(token: string, governance: string, rewards: string, nameOverride: string, symbolOverride: string, guardian: string, management: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setSymbol(symbol: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setGovernance(governance: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        acceptGovernance(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setManagement(management: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setRewards(rewards: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setLockedProfitDegradation(degradation: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setDepositLimit(limit: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setPerformanceFee(fee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setManagementFee(fee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setGuardian(guardian: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setEmergencyShutdown(active: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setWithdrawalQueue(queue: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        transfer(receiver: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        transferFrom(sender: string, receiver: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        approve(spender: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        increaseAllowance(spender: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        decreaseAllowance(spender: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        permit(owner: string, spender: string, amount: BigNumberish, expiry: BigNumberish, signature: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        addStrategy(strategy: string, debtRatio: BigNumberish, minDebtPerHarvest: BigNumberish, maxDebtPerHarvest: BigNumberish, performanceFee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        updateStrategyDebtRatio(strategy: string, debtRatio: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        updateStrategyMinDebtPerHarvest(strategy: string, minDebtPerHarvest: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        updateStrategyMaxDebtPerHarvest(strategy: string, maxDebtPerHarvest: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        updateStrategyPerformanceFee(strategy: string, performanceFee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        migrateStrategy(oldVersion: string, newVersion: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "revokeStrategy()"(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "revokeStrategy(address)"(strategy: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        addStrategyToQueue(strategy: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        removeStrategyFromQueue(strategy: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        report(gain: BigNumberish, loss: BigNumberish, _debtPayment: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "sweep(address)"(token: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "sweep(address,uint256)"(token: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    DOMAIN_SEPARATOR(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        "initialize(address,address,address,string,string)"(token: string, governance: string, rewards: string, nameOverride: string, symbolOverride: string, overrides?: CallOverrides): Promise<void>;
        "initialize(address,address,address,string,string,address)"(token: string, governance: string, rewards: string, nameOverride: string, symbolOverride: string, guardian: string, overrides?: CallOverrides): Promise<void>;
        "initialize(address,address,address,string,string,address,address)"(token: string, governance: string, rewards: string, nameOverride: string, symbolOverride: string, guardian: string, management: string, overrides?: CallOverrides): Promise<void>;
        apiVersion(overrides?: CallOverrides): Promise<string>;
        ...
        permit(owner: string, spender: string, amount: BigNumberish, expiry: BigNumberish, signature: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        totalAssets(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        pricePerShare(overrides?: CallOverrides): Promise<BigNumber>;
        addStrategy(strategy: string, debtRatio: BigNumberish, minDebtPerHarvest: BigNumberish, maxDebtPerHarvest: BigNumberish, performanceFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
        updateStrategyDebtRatio(strategy: string, debtRatio: BigNumberish, overrides?: CallOverrides): Promise<void>;
        updateStrategyMinDebtPerHarvest(strategy: string, minDebtPerHarvest: BigNumberish, overrides?: CallOverrides): Promise<void>;
        updateStrategyMaxDebtPerHarvest(strategy: string, maxDebtPerHarvest: BigNumberish, overrides?: CallOverrides): Promise<void>;
        updateStrategyPerformanceFee(strategy: string, performanceFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        "expectedReturn()"(overrides?: CallOverrides): Promise<BigNumber>;
        "expectedReturn(address)"(strategy: string, overrides?: CallOverrides): Promise<BigNumber>;
        report(gain: BigNumberish, loss: BigNumberish, _debtPayment: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        "Transfer(address,address,uint256)"(sender?: string | null, receiver?: string | null, value?: null): TransferEventFilter;
        Transfer(sender?: string | null, receiver?: string | null, value?: null): TransferEventFilter;
        "Approval(address,address,uint256)"(owner?: string | null, spender?: string | null, value?: null): ApprovalEventFilter;
        Approval(owner?: string | null, spender?: string | null, value?: null): ApprovalEventFilter;
        "StrategyAdded(address,uint256,uint256,uint256,uint256)"(strategy?: string | null, debtRatio?: null, minDebtPerHarvest?: null, maxDebtPerHarvest?: null, performanceFee?: null): StrategyAddedEventFilter;
        StrategyAdded(strategy?: string | null, debtRatio?: null, minDebtPerHarvest?: null, maxDebtPerHarvest?: null, performanceFee?: null): StrategyAddedEventFilter;
        "StrategyReported(address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)"(strategy?: string | null, gain?: null, loss?: null, debtPaid?: null, totalGain?: null, totalLoss?: null, totalDebt?: null, debtAdded?: null, debtRatio?: null): StrategyReportedEventFilter;
        StrategyReported(strategy?: string | null, gain?: null, loss?: null, debtPaid?: null, totalGain?: null, totalLoss?: null, totalDebt?: null, debtAdded?: null, debtRatio?: null): StrategyReportedEventFilter;
        ...
        "StrategyUpdateDebtRatio(address,uint256)"(strategy?: string | null, debtRatio?: null): StrategyUpdateDebtRatioEventFilter;
        StrategyUpdateDebtRatio(strategy?: string | null, debtRatio?: null): StrategyUpdateDebtRatioEventFilter;
        "StrategyUpdateMinDebtPerHarvest(address,uint256)"(strategy?: string | null, minDebtPerHarvest?: null): StrategyUpdateMinDebtPerHarvestEventFilter;
        StrategyUpdateMinDebtPerHarvest(strategy?: string | null, minDebtPerHarvest?: null): StrategyUpdateMinDebtPerHarvestEventFilter;
        "StrategyUpdateMaxDebtPerHarvest(address,uint256)"(strategy?: string | null, maxDebtPerHarvest?: null): StrategyUpdateMaxDebtPerHarvestEventFilter;
        StrategyUpdateMaxDebtPerHarvest(strategy?: string | null, maxDebtPerHarvest?: null): StrategyUpdateMaxDebtPerHarvestEventFilter;
        "StrategyUpdatePerformanceFee(address,uint256)"(strategy?: string | null, performanceFee?: null): StrategyUpdatePerformanceFeeEventFilter;
        StrategyUpdatePerformanceFee(strategy?: string | null, performanceFee?: null): StrategyUpdatePerformanceFeeEventFilter;
        "StrategyMigrated(address,address)"(oldVersion?: string | null, newVersion?: string | null): StrategyMigratedEventFilter;
...
//# sourceMappingURL=YVault.d.ts.map