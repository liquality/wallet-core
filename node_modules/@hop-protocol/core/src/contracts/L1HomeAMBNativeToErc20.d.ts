...
interface L1HomeAMBNativeToErc20Interface extends ethers.utils.Interface {
  functions: {
...
export type FeeDistributedEvent = TypedEvent<
  [BigNumber, string] & { feeAmount: BigNumber; messageId: string }
>;
...
export class L1HomeAMBNativeToErc20 extends BaseContract {
  ...
  interface: L1HomeAMBNativeToErc20Interface;
  ...
  callStatic: {
    ...
    relayTokens(_receiver: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    "FeeDistributed(uint256,bytes32)"(
      ...
      [BigNumber, string],
      { feeAmount: BigNumber; messageId: string }
    >;
    ...
    "FailedMessageFixed(bytes32,address,uint256)"(
      ...
      [string, string, BigNumber],
      { messageId: string; recipient: string; value: BigNumber }
    >;
    ...
    "TokensBridged(address,uint256,bytes32)"(
      ...
      [string, BigNumber, string],
      { recipient: string; value: BigNumber; messageId: string }
    >;
