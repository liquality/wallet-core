...
interface ArbitrumMessengerWrapperInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "defaultCallValue",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ArbitrumMessengerWrapper extends BaseContract {
