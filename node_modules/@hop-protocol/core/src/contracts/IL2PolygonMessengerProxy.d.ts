...
interface IL2PolygonMessengerProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class IL2PolygonMessengerProxy extends BaseContract {
  ...
  interface: IL2PolygonMessengerProxyInterface;
