...
interface L1PolygonMessengerInterface extends ethers.utils.Interface {
  functions: {
...
export class L1PolygonMessenger extends BaseContract {
  ...
  interface: L1PolygonMessengerInterface;
