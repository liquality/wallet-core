...
interface ArbitrumL2ERC20BridgeInterface extends ethers.utils.Interface {
  functions: {
...
export class ArbitrumL2ERC20Bridge extends BaseContract {
  ...
  interface: ArbitrumL2ERC20BridgeInterface;
