...
interface L1PolygonPosRootChainManagerInterface extends ethers.utils.Interface {
  functions: {
...
export type PredicateRegisteredEvent = TypedEvent<
  [string, string] & { tokenType: string; predicateAddress: string }
>;
...
export class L1PolygonPosRootChainManager extends BaseContract {
  ...
  interface: L1PolygonPosRootChainManagerInterface;
