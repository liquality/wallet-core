...
interface MockL2PolygonBridgeInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "messengerProxy",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMessengerProxy",
    values: [string]
  ): string;
  encodeFunctionData(
...
export type L1_BridgeMessageEvent = TypedEvent<[string] & { data: string }>;
...
export class MockL2PolygonBridge extends BaseContract {
  ...
  functions: {
    ...
    setL1BridgeCaller(
      _l1BridgeCaller: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setL1Governance(
      _l1Governance: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "L1_BridgeMessage(bytes)"(
      data?: null
    ): TypedEventFilter<[string], { data: string }>;

    L1_BridgeMessage(data?: null): TypedEventFilter<[string], { data: string }>;
