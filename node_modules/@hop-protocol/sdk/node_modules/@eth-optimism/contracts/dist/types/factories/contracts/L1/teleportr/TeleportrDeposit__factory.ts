...
import type {
  TeleportrDeposit,
  TeleportrDepositInterface,
} from "../../../../contracts/L1/teleportr/TeleportrDeposit";
...
type TeleportrDepositConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TeleportrDepositConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TeleportrDeposit__factory extends ContractFactory {
  constructor(...args: TeleportrDepositConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<TeleportrDeposit> {
    return super.deploy(
      _minDepositAmount,
      _maxDepositAmount,
      _maxBalance,
      overrides || {}
    ) as Promise<TeleportrDeposit>;
  }
  ...
  override attach(address: string): TeleportrDeposit {
    return super.attach(address) as TeleportrDeposit;
  }
  override connect(signer: Signer): TeleportrDeposit__factory {
    return super.connect(signer) as TeleportrDeposit__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TeleportrDepositInterface {
    return new utils.Interface(_abi) as TeleportrDepositInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TeleportrDeposit {
    return new Contract(address, _abi, signerOrProvider) as TeleportrDeposit;
  }
}
