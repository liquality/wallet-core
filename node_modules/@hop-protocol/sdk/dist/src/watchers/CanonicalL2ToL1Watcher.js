...
class L1ToL2Watcher extends BaseWatcher_1.default {
    ...
    pollFn() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.sourceChain.equals(models_1.Chain.Gnosis)) {
    ...
    gnosisWatcher() {
        return __awaiter(this, void 0, void 0, function* () {
            let startBlock = -1;
            let endBlock = -1;
            const canonicalBridge = new CanonicalBridge_1.default(this.network, this.signer, this.token, models_1.Chain.Gnosis);
            const ambBridge = yield canonicalBridge.getAmbBridge(models_1.Chain.Ethereum);
            const filter = {
                address: canonicalBridge.getL1CanonicalTokenAddress(this.token, models_1.Chain.Gnosis)
            };
    ...
    polygonWatcher() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contract = ERC20__factory_1.ERC20__factory.connect(tokenAddress, yield this.getSignerOrProvider(models_1.Chain.Ethereum));
            const filter = {
                topics: []
            };
            const handleEvent = (...args) => __awaiter(this, void 0, void 0, function* () {
