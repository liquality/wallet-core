...
exports.convertERC20 = exports.addTokens = exports.findCompoundToken = exports.getTokenById = exports.hasTokenId = exports.findTokenByAddressInCurrency = exports.findTokenByAddress = exports.findTokenById = exports.findTokenByTicker = exports.listTokenTypesForCryptoCurrency = exports.listTokensForCryptoCurrency = exports.listTokens = void 0;
...
var cardanoNative_1 = __importDefault(require("../data/cardanoNative"));
var stellar_1 = __importDefault(require("../data/stellar"));
...
function convertCardanoNativeTokens(_a) {
    var _b = __read(_a, 8), parentCurrencyId = _b[0], policyId = _b[1], assetName = _b[2], name = _b[3], ticker = _b[4], decimals = _b[5], delisted = _b[6], disableCountervalue = _b[7];
    var assetId = policyId + assetName;
    return {
        type: "TokenCurrency",
        id: "".concat(parentCurrencyId, "/native/").concat(assetId),
        ...
        parentCurrency: (0, currencies_1.getCryptoCurrencyById)(parentCurrencyId),
        tokenType: "native",
        name: name,
        ticker: ticker,
        delisted: delisted,
...
function convertStellarTokens(_a) {
    var _b = __read(_a, 6), assetCode = _b[0], assetIssuer = _b[1], assetType = _b[2], name = _b[3], precision = _b[4], enableCountervalues = _b[5];
    return {
        type: "TokenCurrency",
        id: "stellar/asset/".concat(assetCode, ":").concat(assetIssuer),
        contractAddress: assetIssuer,
        parentCurrency: (0, currencies_1.getCryptoCurrencyById)("stellar"),
        tokenType: assetType,
        name: name,
        ticker: assetCode,
        disableCountervalue: !enableCountervalues,
