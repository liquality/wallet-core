...
function registerCryptoCurrency(id, currency) {
    ...
    if (!currency.isTestnetFor) {
        var currencyAlreadySet = cryptocurrenciesByTicker[currency.ticker];
        var curencyHasTickerinKeywords = Boolean((_a = currency === null || currency === void 0 ? void 0 : currency.keywords) === null || _a === void 0 ? void 0 : _a.includes(currency.ticker));
...
function findCryptoCurrencyById(id) {
    return exports.cryptocurrenciesById[id];
}
exports.findCryptoCurrencyById = findCryptoCurrencyById;
var testsMap = {
    keywords: function (s) {
        return findCryptoCurrency(function (c) {
            var _a;
            return Boolean((_a = c === null || c === void 0 ? void 0 : c.keywords) === null || _a === void 0 ? void 0 : _a.map(function (k) { return k.replace(/ /, "").toLowerCase(); }).includes(s));
        });
    },
    name: function (s) {
        return findCryptoCurrency(function (c) { return c.name.replace(/ /, "").toLowerCase() === s; });
    },
    id: function (s) { return findCryptoCurrencyById(s.toLowerCase()); },
    ticker: function (s) { return findCryptoCurrencyByTicker(s.toUpperCase()); },
    manager: function (s) { return (0, exports.findCryptoCurrencyByManagerAppName)(s); }
};
/**
 *
 * @param {*} keyword
...
var findCryptoCurrencyByManagerAppName = function (managerAppName) {
    var search = managerAppName.replace(/ /, "").toLowerCase();
    return (findCryptoCurrency(function (c) { return c.managerAppName === managerAppName; }) ||
        findCryptoCurrency(function (c) {
            return Boolean(c.managerAppName &&
                c.managerAppName.replace(/ /, "").toLowerCase() === search);
        }));
};
exports.findCryptoCurrencyByManagerAppName = findCryptoCurrencyByManagerAppName;
/**
 *
 * @param {*} id
 */
