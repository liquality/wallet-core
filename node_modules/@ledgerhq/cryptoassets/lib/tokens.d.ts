...
export declare function addTokens(list: TokenCurrency[]): void;
export declare function convertERC20([parentCurrencyId, token, ticker, magnitude, name, ledgerSignature, contractAddress, disableCountervalue, delisted, countervalueTicker, compoundFor,]: ERC20Token): TokenCurrency;
export {};
