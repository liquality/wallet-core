...
export var cryptocurrenciesById = {
    near: {
        type: "CryptoCurrency",
        id: "near",
        coinType: 397,
...
var testsMap = {
    ...
    manager: function (s) { return findCryptoCurrencyByManagerAppName(s); }
};
/**
 *
 * @param {*} keyword
 */
export var findCryptoCurrencyByKeyword = function (keyword, tests) {
    var e_1, _a;
...
export var findCryptoCurrencyByManagerAppName = function (managerAppName) {
