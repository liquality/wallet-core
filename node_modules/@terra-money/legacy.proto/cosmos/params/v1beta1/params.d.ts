...
export declare const ParameterChangeProposal: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): ParameterChangeProposal;
...
export declare const ParamChange: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): ParamChange;
