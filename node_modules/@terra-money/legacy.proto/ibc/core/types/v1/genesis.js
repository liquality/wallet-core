...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        if (object.clientGenesis !== undefined && object.clientGenesis !== null) {
            message.clientGenesis = genesis_1.GenesisState.fromJSON(object.clientGenesis);
        }
        else {
            message.clientGenesis = undefined;
        }
        if (object.connectionGenesis !== undefined && object.connectionGenesis !== null) {
            message.connectionGenesis = genesis_2.GenesisState.fromJSON(object.connectionGenesis);
        }
        else {
            message.connectionGenesis = undefined;
        }
        if (object.channelGenesis !== undefined && object.channelGenesis !== null) {
            message.channelGenesis = genesis_3.GenesisState.fromJSON(object.channelGenesis);
        }
        else {
