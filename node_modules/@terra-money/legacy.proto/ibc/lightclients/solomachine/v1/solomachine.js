...
const baseHeader = { sequence: long_1.default.UZERO, timestamp: long_1.default.UZERO, newDiversifier: "" };
exports.Header = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.sequence.isZero()) {
            writer.uint32(8).uint64(message.sequence);
...
const baseSignBytes = { sequence: long_1.default.UZERO, timestamp: long_1.default.UZERO, diversifier: "", dataType: 0 };
exports.SignBytes = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.sequence.isZero()) {
            writer.uint32(8).uint64(message.sequence);
