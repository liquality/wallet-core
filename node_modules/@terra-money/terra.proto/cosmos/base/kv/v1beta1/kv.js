...
exports.Pairs = {
    ...
    decode(input, length) {
        ...
        const message = Object.assign({}, basePairs);
        message.pairs = [];
    ...
    fromJSON(object) {
        ...
        if (object.pairs !== undefined && object.pairs !== null) {
            for (const e of object.pairs) {
                message.pairs.push(exports.Pair.fromJSON(e));
            }
        }
        return message;
    },
    ...
    fromPartial(object) {
        ...
        if (object.pairs !== undefined && object.pairs !== null) {
            for (const e of object.pairs) {
                message.pairs.push(exports.Pair.fromPartial(e));
            }
        }
        return message;
    },
...
exports.Pair = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, basePair);
