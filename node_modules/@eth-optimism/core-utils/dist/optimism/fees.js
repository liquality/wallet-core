...
const calldataCost = (data) => {
    ...
    const zeroCost = ethers_1.BigNumber.from(zeros).mul(exports.txDataZeroGas);
    const nonZeroCost = ethers_1.BigNumber.from(ones).mul(exports.txDataNonZeroGasEIP2028);
