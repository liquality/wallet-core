...
const toTransactionHash = (transaction) => {
    if (typeof transaction === 'string') {
        (0, assert_1.default)(ethers_1.ethers.utils.isHexString(transaction, 32), 'Invalid transaction hash');
        return transaction;
    }
...
const toAddress = (addr) => {
    if (typeof addr === 'string') {
        (0, assert_1.default)(ethers_1.ethers.utils.isAddress(addr), 'Invalid address');
        return ethers_1.ethers.utils.getAddress(addr);
    }
    else {
        (0, assert_1.default)(ethers_1.ethers.utils.isAddress(addr.address), 'Invalid address');
