...
class StandardBridgeAdapter {
    constructor(opts) {
        ...
        this.l2Bridge = new ethers_1.Contract((0, utils_1.toAddress)(opts.l2Bridge), (0, contracts_1.getContractInterface)('IL2ERC20Bridge'), this.messenger.l2Provider);
    }
    async getDepositsByAddress(address, opts) {
        ...
        return events
            ...
            return (!(0, core_utils_1.hexStringEquals)(event.args._l1Token, ethers_1.ethers.constants.AddressZero) &&
                !(0, core_utils_1.hexStringEquals)(event.args._l2Token, contracts_1.predeploys.OVM_ETH));
        })
            .map((event) => {
            return {
