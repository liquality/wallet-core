...
const goerli_nightly__AddressDictator = require('../deployments/goerli-nightly/AddressDictator.json');
const goerli_nightly__BondManager = require('../deployments/goerli-nightly/BondManager.json');
const goerli_nightly__CanonicalTransactionChain = require('../deployments/goerli-nightly/CanonicalTransactionChain.json');
const goerli_nightly__ChainStorageContainer_CTC_batches = require('../deployments/goerli-nightly/ChainStorageContainer-CTC-batches.json');
const goerli_nightly__ChainStorageContainer_SCC_batches = require('../deployments/goerli-nightly/ChainStorageContainer-SCC-batches.json');
const goerli_nightly__ChugSplashDictator = require('../deployments/goerli-nightly/ChugSplashDictator.json');
const goerli_nightly__L1StandardBridge_for_verification_only = require('../deployments/goerli-nightly/L1StandardBridge_for_verification_only.json');
const goerli_nightly__Lib_AddressManager = require('../deployments/goerli-nightly/Lib_AddressManager.json');
const goerli_nightly__OVM_L1CrossDomainMessenger = require('../deployments/goerli-nightly/OVM_L1CrossDomainMessenger.json');
const goerli_nightly__Proxy__OVM_L1CrossDomainMessenger = require('../deployments/goerli-nightly/Proxy__OVM_L1CrossDomainMessenger.json');
const goerli_nightly__Proxy__OVM_L1StandardBridge = require('../deployments/goerli-nightly/Proxy__OVM_L1StandardBridge.json');
const goerli_nightly__StateCommitmentChain = require('../deployments/goerli-nightly/StateCommitmentChain.json');
...
const kovan__TeleportrDeposit = require('../deployments/kovan/TeleportrDeposit.json');
...
const mainnet__TeleportrDeposit = require('../deployments/mainnet/TeleportrDeposit.json');
const optimism_kovan__TeleportrDisburser = require('../deployments/optimism-kovan/TeleportrDisburser.json');
const optimism_mainnet__TeleportrDisburser = require('../deployments/optimism-mainnet/TeleportrDisburser.json');
const getDeployedContractArtifact = (name, network) => {
    return {
        ...
        goerli_nightly__AddressDictator,
        goerli_nightly__BondManager,
        goerli_nightly__CanonicalTransactionChain,
        goerli_nightly__ChainStorageContainer_CTC_batches,
        goerli_nightly__ChainStorageContainer_SCC_batches,
        goerli_nightly__ChugSplashDictator,
        goerli_nightly__L1StandardBridge_for_verification_only,
        goerli_nightly__Lib_AddressManager,
        goerli_nightly__OVM_L1CrossDomainMessenger,
        goerli_nightly__Proxy__OVM_L1CrossDomainMessenger,
        goerli_nightly__Proxy__OVM_L1StandardBridge,
        goerli_nightly__StateCommitmentChain,
        ...
        optimism_kovan__TeleportrDisburser,
        optimism_mainnet__TeleportrDisburser
