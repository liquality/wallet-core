...
export type NamedAddressStruct = { name: string; addr: string };
...
export interface AddressDictatorInterface extends ethers.utils.Interface {
  functions: {
...
export interface AddressDictator extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[NamedAddressStructOutput[]]>;
