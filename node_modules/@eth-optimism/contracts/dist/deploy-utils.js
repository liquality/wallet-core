...
const deployAndVerifyAndThen = async ({ hre, name, args, contract, iface, postDeployAction, }) => {
    ...
    const deployConfig = (0, deploy_config_1.getDeployConfig)(hre.network.name);
...
const getAdvancedContract = (opts) => {
    const deployConfig = (0, deploy_config_1.getDeployConfig)(opts.hre.network.name);
    ...
    for (const fnName of Object.keys(contract.functions)) {
        ...
        contract[fnName] = async (...args) => {
            ...
            while (true) {
                ...
                else if (receipt.confirmations >= deployConfig.numDeployConfirmations) {
                    return tx;
                }
            }
        };
