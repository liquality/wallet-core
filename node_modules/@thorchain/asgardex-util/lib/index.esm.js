 ...
 */
({ chain: Chain.Binance, symbol: 'BNB', ticker: 'BNB' });
/**
 ...
 * @see https://gitlab.com/thorchain/thornode/-/blob/master/common/asset.go#L12-24
 */
({ chain: Chain.Bitcoin, symbol: 'BTC', ticker: 'BTC' });
/**
 ...
 * @see https://gitlab.com/thorchain/thornode/-/blob/master/common/asset.go#L12-24
 */
({ chain: Chain.BitcoinCash, symbol: 'BCH', ticker: 'BCH' });
/**
 ...
 * @see https://gitlab.com/thorchain/thornode/-/blob/master/common/asset.go#L12-24
 */
({ chain: Chain.Ethereum, symbol: 'ETH', ticker: 'ETH' });
/**
 ...
 * @see https://gitlab.com/thorchain/thornode/-/blob/master/common/asset.go#L12-24
 */
({ chain: Chain.Binance, symbol: 'RUNE-67C', ticker: RUNE_TICKER });
/**
 ...
 * @see https://gitlab.com/thorchain/thornode/-/blob/master/common/asset.go#L12-24
 */
({ chain: Chain.Binance, symbol: 'RUNE-B1A', ticker: RUNE_TICKER });
/**
 ...
 * @see https://gitlab.com/thorchain/thornode/-/blob/master/common/asset.go#L12-24
 */
({ chain: Chain.THORChain, symbol: RUNE_TICKER, ticker: RUNE_TICKER });
/**
...
var filterMemoPart = function (part) { return part !== null && part !== undefined; };
// helper to create memo by given list of values
var mkMemo = function (values) { return values.filter(filterMemoPart).join(DELIMITER); };
// Helper to create asset string from asset used in memo's
var assetToMemoString = function (_a) {
    var chain = _a.chain, symbol = _a.symbol;
    return "".concat(chain, ".").concat(symbol);
};
/**
 * Memo to swap
 *
...
var getSwapMemo = function (_a) {
    ...
    // `address` can be empty string, but not undefined to make sure it will be part[2] in memo
    // @see `ParseSwapMemo` https://gitlab.com/thorchain/thornode/-/blob/develop/x/thorchain/memo/memo_swap.go#L45-54
    address = _c === void 0 ? '' : _c, limit = _a.limit, _d = _a.short, short = _d === void 0 ? true : _d;
    return mkMemo(["".concat(short ? '=' : 'SWAP'), assetToMemoString(asset), address, (_b = limit === null || limit === void 0 ? void 0 : limit.amount().toString()) !== null && _b !== void 0 ? _b : null]);
};
/**
 * Memo to deposit
 *
 ...
 */
var getDepositMemo = function (_a) {
    var asset = _a.asset, _b = _a.address, address = _b === void 0 ? '' : _b, _c = _a.short, short = _c === void 0 ? true : _c;
    return mkMemo(["".concat(short ? '+' : 'ADD'), assetToMemoString(asset), address || null]);
};
/**
 * Memo to withdraw
 *
 ...
 * @see https://docs.thorchain.org/developers/transaction-memos#transactions
 */
var getWithdrawMemo = function (_a) {
    var asset = _a.asset, percent = _a.percent, targetAsset = _a.targetAsset, _b = _a.short, short = _b === void 0 ? true : _b;
    var target = targetAsset ? assetToMemoString(targetAsset) : null;
    // Accept percent between 0 - 100 only
    percent = Math.min(Math.max(percent, 0), 100);
    // Calculate percent into basis points (0-10000, where 100%=10000)
    var points = percent * 100;
    var memo = short ? '-' : 'WITHDRAW';
 ...
 */
var getSwitchMemo = function (address) { return mkMemo(['SWITCH', address]); };
/**
 * Memo to bond
 *
 ...
 */
var getBondMemo = function (thorAddress) { return mkMemo(['BOND', thorAddress]); };
/**
 * Memo to unbond
 *
 ...
 */
var getUnbondMemo = function (thorAddress, units) {
    return mkMemo(['UNBOND', thorAddress, units.amount().toString()]);
};
/**
 * Memo to leave
 *
 ...
 */
var getLeaveMemo = function (thorAddress) { return mkMemo(['LEAVE', thorAddress]); };

export { getBondMemo, getDepositMemo, getDoubleSwapFee, getDoubleSwapInput, getDoubleSwapOutput, getDoubleSwapOutputWithFee, getDoubleSwapSlip, getLeaveMemo, getPoolShare, getSlipOnStake, getStakeUnits, getSwapFee, getSwapInput, getSwapMemo, getSwapOutput, getSwapOutputWithFee, getSwapSlip, getSwitchMemo, getUnbondMemo, getValueOfAsset1InAsset2, getValueOfAssetInRune, getValueOfRuneInAsset, getWithdrawMemo };
