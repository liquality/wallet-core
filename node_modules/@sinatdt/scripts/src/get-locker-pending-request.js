...
async function getLockerPendingRequests(
  lockerBtcAddress,
  ...
  return {
    ...
    unsubmittedAmount:
      pendingRequests.reduce((a, c) => a + Number(c.request?.value || 0), 0) +
      confirmedRequests.reduce((a, c) => a + Number(c.request?.value || 0), 0),
  }
}
